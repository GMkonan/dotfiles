# Generated by Powerlevel10k configuration wizard on 2024-06-17 at 04:16 -03.
...
# angled separators, flat heads, flat tails, 2 lines, disconnected, left frame, sparse,
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    # =========================[ Line #1 ]=========================
    bonfire                 # custom prompt konan@bonfire
  ...
  # prompt connection/ lines/ connect lines/ connected lines
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='香'

  ################################[ prompt_char: prompt symbol ]################################
  # Transparent background.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_BACKGROUND=
  # Green prompt symbol if the last command succeeded.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=238
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      # This way you can pass hex code to zsh color format
      # https://github.com/romkatv/powerlevel10k/issues/207#issuecomment-529227785
      local      clean='%F{#a6e3a1\}'   # green foreground (default was %76F)
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR='#a6e3a1' #76
  ...
  # kitty supports truecolor (24-bit colors) so you can use hex codes instead of numbered
  function prompt_bonfire() {
    p10k segment -f '#fab387' -i '' -t 'konan@bonfire'
  }
  ...
  function instant_prompt_bonfire() {
    prompt_bonfire
  }
